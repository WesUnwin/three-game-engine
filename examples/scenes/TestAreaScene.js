...
const sceneData = {
    gameObjects: [
      ...
      {
        type: 'Platform2_2_05',  // floating platform left of back row
        position: { x: -4, y: 2.5, z: -14 }
      },

      {
        type: 'Platform2_2_2', // left staircase, highest step
      ...
      {
        type: 'Platform2_2_05', // left staircase, lowest step
        position: { x: -1, y: 0.25, z: 0 }
      },


      {
        type: 'Platform2_2_2', // middle staircase, highest step
      ...
      {
        type: 'Platform2_2_1',  // middle staircase, lowest step
        position: { x: 1, y: 0.25, z: -8 }
      },

      {
        type: 'Platform2_2_1',  // right staircase, single step
