...
const SoundComponent = ({ componentJSON, onChange, onRemove, audioType = "PositionalAudio" }) => {
  ...
  if (!properties) {
    throw new Error(`SoundComponent: invalid audioType: ${audioType}`);
  }

  return (
    <TreeView
      label={componentJSON.name}
      expandOnClick={true}
      actions={[
